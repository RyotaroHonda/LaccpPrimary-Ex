...
create_clock -period 1.600 -name clk_fast -waveform {0.000 0.800} [get_pins u_BUFG_Fast/O]
set_input_jitter clk_fast 0.030

create_clock -period 8.000 -name clk_slow -waveform {0.000 4.000} [get_pins u_BUFG_Slow/O]
